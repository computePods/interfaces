// This is the collection of All NPM Express routes
...
export function All_handlers(app) {
  return [
  
    // taskStatus handlers
    
      // example task status
      app.get(buildUrl({'mountPoint': '/build/status', 'workspacePath': '/a/workspace/path', 'project': 'aProject', 'target': 'aBuildTarget', 'taskPath': 'example'}), (req, res) => {
        console.log("Serving mockServer example: ["+buildUrl({'mountPoint': '/build/status', 'workspacePath': '/a/workspace/path', 'project': 'aProject', 'target': 'aBuildTarget', 'taskPath': 'example'})+"]")
        res.json({
            "dependencies": [
              "example1",
              "anOther/task"
    ...
    // buildTasks handlers
      ...
      // example list of build tasks
      app.get(buildUrl({'mountPoint': '/build/current'}), (req, res) => {
        console.log("Serving mockServer example: ["+buildUrl({'mountPoint': '/build/current'})+"]")
        res.json([
            {
              "dependencies": [
                "example"
    ...
    // workspaceTree handlers
    
      // Measuring Heyting Algebras workspace
      app.get(buildUrl({'mountPoint': '/files', 'workspacePath': 'measuringHeyting'}), (req, res) => {
        console.log("Serving mockServer example: ["+buildUrl({'mountPoint': '/files', 'workspacePath': 'measuringHeyting'})+"]")
        res.json({
            "directories": {
              "heytingSymmetries": {
                "directories": {},
    ...
    // logFileJson handlers
    
      // an example log file
      app.get(buildUrl({'mountPoint': '/logfile', 'workspacePath': '/a/workspace/path', 'project': 'aProject', 'target': 'aTarget', 'taskPath': 'an/example/log'}), (req, res) => {
        console.log("Serving mockServer example: ["+buildUrl({'mountPoint': '/logfile', 'workspacePath': '/a/workspace/path', 'project': 'aProject', 'target': 'aTarget', 'taskPath': 'an/example/log'})+"]")
        res.json({
            "lines": [
    ...
    // projectDefinition handlers
    
      // Project definition for the 'Measuring Heyting algebras' paper
      app.get(buildUrl({'mountPoint': '/projects', 'workspacePath': 'measuringHeyting', 'project': 'project.yaml'}), (req, res) => {
        console.log("Serving mockServer example: ["+buildUrl({'mountPoint': '/projects', 'workspacePath': 'measuringHeyting', 'project': 'project.yaml'})+"]")
        res.json({
    ...
    // entityInterfaceMapping handlers
    
      // The current entity to interface mapping
      app.get(buildUrl({'mountPoint': '/entity/interface/mapping'}), (req, res) => {
        console.log("Serving mockServer example: ["+buildUrl({'mountPoint': '/entity/interface/mapping'})+"]")
        res.json({
            "task": "targetStatus"
          })
      }),
    ...
    // notifications handlers
      ...
      app.sse(buildUrl({'mountPoint': '/notifications'}), (req, res) => {
        console.log("Serving mockServer example: ["+buildUrl({'mountPoint': '/notifications'})+"]")
        res.json([
            {
